                            ...
                            {isProfileMenuOpen && (
                                <div className="absolute right-0 mt-3 w-56 bg-white dark:bg-[#161b22] rounded-xl shadow-xl border border-gray-200 dark:border-white/10 overflow-hidden animate-fadeIn origin-top-right">
                                    ...
                                    <div className="py-1">
                                        ...
                                        <button onClick={() => navAction('carpool')} className="w-full text-left px-4 py-2.5 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-white/5 flex items-center gap-2">
                                        ...
                                        <button onClick={() => navAction('friends')} className="w-full text-left px-4 py-2.5 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-white/5 flex items-center gap-2">
