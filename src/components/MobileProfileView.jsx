        ...
        <div className="flex flex-col gap-6 pb-20">
            ...
            <div className="overflow-x-auto no-scrollbar -mx-4 px-4 py-2">
                <nav className="flex items-center gap-3 min-w-max">
                    <button className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-purple-600 dark:text-purple-400 bg-purple-50 dark:bg-purple-900/20 rounded-full transition-colors whitespace-nowrap border border-purple-200 dark:border-purple-800 shadow-[0_0_10px_rgba(168,85,247,0.15)]">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>
                        Profile
                    </button>
                    <button onClick={() => alert('Car Pooling coming soon!')} className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border border-gray-200 dark:border-gray-700 rounded-full whitespace-nowrap active:bg-gray-50 dark:active:bg-slate-700">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                        Car Pooling
                    </button>
                    <button onClick={() => alert('Friends coming soon!')} className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border border-gray-200 dark:border-gray-700 rounded-full whitespace-nowrap active:bg-gray-50 dark:active:bg-slate-700">
