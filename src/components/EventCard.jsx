                    ...
                    <div className="mt-6 flex justify-between items-end">
                        ...
                        {isJoined && (
                            <div
                                ...
                                className="p-2 bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 rounded-lg hover:bg-purple-200 dark:hover:bg-purple-900/50 transition-colors cursor-pointer z-20 relative"
                                title="Carpool"
                            >
                                <Car size={20} />
                            </div>
